import{_ as s,c as n,o as a,a as l}from"./app.160e7605.js";const A=JSON.parse('{"title":"js面向对象的特性","description":"","frontmatter":{"title":"js面向对象的特性","author":"Zack Zheng","date":"2021/10/02 14:00","categories":["JavaScript语言精髓与编程实践"],"tags":["JavaScript"]},"headers":[],"relativePath":"books/techAndCodes/JavaScript语言精髓与编程实践/js面向对象的特性.md","lastUpdated":1676456607000}'),p={name:"books/techAndCodes/JavaScript语言精髓与编程实践/js面向对象的特性.md"},o=l(`<div class="vp-code-group"><div class="tabs"><input type="radio" name="group-SDfMZ" id="tab-7-rhtY3" checked="checked"><label for="tab-7-rhtY3">使用构造器创建对象实例</label><input type="radio" name="group-SDfMZ" id="tab-xtYmS5J"><label for="tab-xtYmS5J">对象字面量声明</label></div><div class="blocks"><div class="language-js active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 对象的声明和实例创建</span></span>
