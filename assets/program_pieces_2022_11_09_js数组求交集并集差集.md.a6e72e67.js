import{_ as s,c as n,o as a,a as l}from"./app.0c5fc1fa.js";const C=JSON.parse('{"title":"js数组求交集并集差集","description":"","frontmatter":{"title":"js数组求交集并集差集","author":"Zack Zheng","date":"2022/11/09 09:51","categories":["大海拾遗"],"tags":["JavaScript"]},"headers":[],"relativePath":"program/pieces/2022/11/09/js数组求交集并集差集.md","lastUpdated":1676537933000}'),p={name:"program/pieces/2022/11/09/js数组求交集并集差集.md"},e=l(`<p>表示最大最小数值 Number.MAX_VALUE Number.MIN_VALUE</p><p>表示无穷大、无穷小 Infinity、-Infinity</p><hr><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#A6ACCD;">var a = [1,2,3,4,5]</span></span>
