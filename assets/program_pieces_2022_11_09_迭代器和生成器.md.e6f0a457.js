import{_ as s,c as n,o as a,a as l}from"./app.c48905b3.js";const C=JSON.parse('{"title":"迭代器和生成器","description":"","frontmatter":{"title":"迭代器和生成器","author":"Zack Zheng","date":"2022/11/09 09:51","categories":["大海拾遗"],"tags":["JavaScript"]},"headers":[{"level":3,"title":"迭代器与生成器","slug":"迭代器与生成器","link":"#迭代器与生成器","children":[]},{"level":3,"title":"生成器","slug":"生成器","link":"#生成器","children":[]}],"relativePath":"program/pieces/2022/11/09/迭代器和生成器.md","lastUpdated":1676537933000}'),e={name:"program/pieces/2022/11/09/迭代器和生成器.md"},p=l(`<h3 id="迭代器与生成器" tabindex="-1">迭代器与生成器 <a class="header-anchor" href="#迭代器与生成器" aria-hidden="true">#</a></h3><p>实现了正式的Iterable接口，就可以通过迭代器Iterator消费</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#A6ACCD;">// 这个类实现了可迭代接口（Iterable）</span></span>
