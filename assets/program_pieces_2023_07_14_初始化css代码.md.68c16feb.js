import{_ as s,c as n,o as a,a as l}from"./app.1e324fbd.js";const B=JSON.parse('{"title":"初始化css代码","description":"","frontmatter":{"title":"初始化css代码","author":"Zack Zheng","date":"2023/07/14 00:00","categories":["CSS"],"tags":["CSS"]},"headers":[],"relativePath":"program/pieces/2023/07/14/初始化css代码.md","lastUpdated":1689324171000}'),p={name:"program/pieces/2023/07/14/初始化css代码.md"},e=l(`<p>初始化css即normalize.css</p><p><a href="https://github.com/necolas/normalize.css/blob/master/normalize.css" target="_blank" rel="noreferrer">源文件地址</a></p><div class="language-css line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#676E95;font-style:italic;">/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */</span></span>
