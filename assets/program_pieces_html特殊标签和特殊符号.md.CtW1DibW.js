import{_ as a,c as n,o as p,aG as e}from"./chunks/framework.CdnsPyyz.js";const o=JSON.parse('{"title":"html特殊标签和特殊符号","description":"","frontmatter":{"title":"html特殊标签和特殊符号","author":"Zack Zheng","date":"2021/02/05 22:36","categories":["大海拾遗"],"tags":["Html"]},"headers":[],"relativePath":"program/pieces/html特殊标签和特殊符号.md","filePath":"program/pieces/html特殊标签和特殊符号.md","lastUpdated":1741325738000}'),l={name:"program/pieces/html特殊标签和特殊符号.md"};function i(r,s,t,c,b,m){return p(),n("div",null,s[0]||(s[0]=[e(`<hr><h4 id="符集介绍" tabindex="-1">符集介绍 <a class="header-anchor" href="#符集介绍" aria-label="Permalink to &quot;符集介绍&quot;">​</a></h4><p>gb2312 国标6763个汉字 BIG5 繁体中文 GBK 全部中文，国标扩展 gb2312扩展包含繁体 UTF-8基本包含全世界所有国家包含的字符</p><hr><h4 id="横线、换行、加粗、删除线、下划线标签" tabindex="-1">横线、换行、加粗、删除线、下划线标签 <a class="header-anchor" href="#横线、换行、加粗、删除线、下划线标签" aria-label="Permalink to &quot;横线、换行、加粗、删除线、下划线标签&quot;">​</a></h4><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>&lt;hr /&gt;   </span></span>
