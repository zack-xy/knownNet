import{a0 as n,X as a,V as p,at as e}from"./chunks/framework.B7O4o3WH.js";const u=JSON.parse('{"title":"js数组求交集并集差集","description":"","frontmatter":{"title":"js数组求交集并集差集","author":"Zack Zheng","date":"2022/11/09 09:51","categories":["大海拾遗"],"tags":["JavaScript"]},"headers":[],"relativePath":"program/pieces/js数组求交集并集差集.md","filePath":"program/pieces/js数组求交集并集差集.md","lastUpdated":1741325738000}'),l={name:"program/pieces/js数组求交集并集差集.md"};function r(i,s,t,c,b,o){return a(),p("div",null,[...s[0]||(s[0]=[e(`<p>表示最大最小数值 Number.MAX_VALUE Number.MIN_VALUE</p><p>表示无穷大、无穷小 Infinity、-Infinity</p><hr><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>var a = [1,2,3,4,5]</span></span>
