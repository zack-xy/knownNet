import{a0 as n,X as a,V as p,at as e}from"./chunks/framework.CZqo6F6J.js";const o=JSON.parse('{"title":"span标签的文字如何支持直接编辑","description":"","frontmatter":{"title":"span标签的文字如何支持直接编辑","author":"Zack Zheng","date":"2023/07/14 00:01","categories":["HTML"],"tags":["HTML"]},"headers":[],"relativePath":"program/pieces/span标签的文字如何支持直接编辑.md","filePath":"program/pieces/span标签的文字如何支持直接编辑.md","lastUpdated":1741325738000}'),l={name:"program/pieces/span标签的文字如何支持直接编辑.md"};function i(r,s,c,t,b,u){return a(),p("div",null,[...s[0]||(s[0]=[e(`<p>声明contenteditable属性为true即可</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>&lt;template&gt;</span></span>
