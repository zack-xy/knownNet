import{_ as s,o as a,c as e,aG as p}from"./chunks/framework.Cb5WhppN.js";const d=JSON.parse('{"title":"迭代器和生成器","description":"","frontmatter":{"title":"迭代器和生成器","author":"Zack Zheng","date":"2022/11/09 09:51","categories":["大海拾遗"],"tags":["JavaScript"]},"headers":[],"relativePath":"program/pieces/迭代器和生成器.md","filePath":"program/pieces/迭代器和生成器.md","lastUpdated":1741325738000}'),l={name:"program/pieces/迭代器和生成器.md"};function r(i,n,c,t,o,b){return a(),e("div",null,[...n[0]||(n[0]=[p(`<h3 id="迭代器与生成器" tabindex="-1">迭代器与生成器 <a class="header-anchor" href="#迭代器与生成器" aria-label="Permalink to &quot;迭代器与生成器&quot;">​</a></h3><p>实现了正式的Iterable接口，就可以通过迭代器Iterator消费</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>// 这个类实现了可迭代接口（Iterable）</span></span>
