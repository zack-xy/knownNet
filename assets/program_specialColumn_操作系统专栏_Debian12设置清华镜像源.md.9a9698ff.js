import{_ as s,c as n,o as a,a as e}from"./app.cf1ad779.js";const d=JSON.parse('{"title":"设置Debian12清华镜像源","description":"","frontmatter":{"title":"设置Debian12清华镜像源","date":"2024/01/02 00:00:00","categories":["Debian"],"tags":["Debian"]},"headers":[],"relativePath":"program/specialColumn/操作系统专栏/Debian12设置清华镜像源.md","lastUpdated":1740468438000}'),p={name:"program/specialColumn/操作系统专栏/Debian12设置清华镜像源.md"},l=e(`<p><a href="https://mirrors.tuna.tsinghua.edu.cn/help/debian/" target="_blank" rel="noreferrer">清华镜像地址</a></p><p>1、防止无法拉取HTTPS源</p><p><code>apt install apt-transport-https ca-certificates</code></p><p>2、修改<code>/etc/apt/sources.list.d/debian.sources</code>这个文件内容如下</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight vp-code-dark"><code><span class="line"><span style="color:#A6ACCD;">Types: deb</span></span>
