...
export default defineComponent({
  ...
  setup() {
    ...
    const dataSource: Readonly<BKData> = Object.freeze([
      ...
      { key: '3', name: '佛陀传', progress: '100%', times: '第1遍结束', status: '队列待定' },
      ...
      { key: '9', name: 'CSS世界', progress: '第四章 温和的padding属性', times: '第1遍', status: '未知' },
      { key: '10', name: '编程与类型系统', progress: '?', times: '第1遍', status: '未知' },
    ])
      ...
      return (
        <div class="">
          <a-table dataSource={dataSource} columns={columns} pagination={false}>
            {{
              headerCell: ({ column }: { column: BKColumn }) => getTableIcon(column),
            }}
          </a-table>
        </div>
      )
